...
<head>
    ...
    <link rel="stylesheet" href="public/vendor/css/wow.css">
    ...
    <!-- Style Sheet -->
    <link href="public/builder-construction/css/style.css" rel="stylesheet">
    <link href="public/builder-construction/css/custom.css" rel="stylesheet">
   <link href="public/builder-construction/css/line-awesome.min.css" rel="stylesheet">
</head>
    ...
    <nav class="navbar navbar-top-default navbar-expand-lg  nav-box-round navbar-simple nav-line">
        <div class="container">
            <a href="#home" title="Logo" class="logo">
                <!--Logo Default-->
                <img src="public/builder-construction/images/logo.png" alt="logo" class="logo-dark">
            </a>

            <!--Nav Links-->
            <div class="collapse navbar-collapse" id="megaone">
                <div class="navbar-nav ml-auto">
                    <a class="nav-link active scroll " href="#home">Trang chủ<span></span></a>
                    <a class="nav-link scroll " href="#about">Về chúng tôi<span></span></a>
                    <a class="nav-link scroll " href="#company-portfolio-section">Dự án<span></span></a>
                    <a class="nav-link scroll " href="#release">Tin tức<span></span></a>
        ...
        <div class="inner-wrapper">
            ...
            <nav class="side-nav w-100">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link scroll" href="#company-portfolio-section">Dự án</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link scroll" href="#release">Tin tức</a>
                    </li>
                    <li class="nav-item">
...
<section class="reviews-sec bg-image" id="reviews">
        ...
        <div class="section-heading">
            <div class="row">
                <div class="col-lg-6 wow fadeInUp text-center text-lg-left" data-wow-delay="300ms">
                    <h1 class="heading">Our<span class="d-block">
                        Amazing Projects </span></h1>
                ...
                <div class="col-md-12 pt-4 pt-md-5">
                    <div id="js-filters-mosaic" class="cbp-l-filters-button wow fadeInUp text-center text-lg-left" data-wow-delay="350ms">
                        ...
                        <div data-filter=".web" class="cbp-filter-item">Houses</div>
                        <div data-filter=".logo" class="cbp-filter-item">Building</div>
                        <div data-filter=".mobile" class="cbp-filter-item">Others</div>
                    </div>
                    <div id="js-grid-mosaic" class="cbp cbp-l-grid-mosaic">
                        <!-- Image-1 -->
                        <div class="cbp-item web logo">
                            <a href="public/builder-construction/images/protfolio-1.png" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="public/builder-construction/images/protfolio-1.png" alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    ...
                                    <div class="hover-text">
                                        <h4 class="p-hover-title">Amazing House</h4>
                                        <p class="p-hover-des">Awesome Spanish House</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="cbp-item print mobile web">
                            <a href="public/builder-construction/images/portfolio-2.png" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="public/builder-construction/images/portfolio-2.png" alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                        <h4 class="p-hover-title">White House</h4>
                                        <p class="p-hover-des">Awesome Spanish House</p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="cbp-item print logo development web mobile">
                            <a href="public/builder-construction/images/portfolio-3.png" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="public/builder-construction/images/portfolio-3.png" alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <div class="portfolio-inner-content">
                                        <span></span>
                                    ...
                                    <div class="hover-text">
                                        <h4 class="p-hover-title">Regency Villa</h4>
                                        <p class="p-hover-des">Awesome Spanish House</p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="cbp-item logo development">
                            <a href="public/builder-construction/images/portfolio-4.png" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="public/builder-construction/images/portfolio-4.png" alt="img">
                                </div>
                                <div class="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    <div class="portfolio-inner-content">
                                        <span></span>
                    ...
                    <div id="js-loadMore-lightbox-gallery" class="cbp-l-loadMore-button text-data wow fadeInUp" data-wow-delay="650ms">
                        <div class="row portfolio-foot-detail text-data-inner">
                            ...
                            <div class="col-5 col-lg-2 d-flex justify-content-end align-items-center"><a href="public/builder-construction/project-detail.html" class="btn pink-and-yellow-btn rounded-pill">VIEW ALL</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Start Press Release -->
<section class="release-sec bg-yellow" id="release">
    <div class="container">
        <div class="row">
            <!-- content -->
            ...
            <div class="col-lg-4">
                <div class="release-area wow slideInLeft" data-wow-delay=".5s">
                    ...
                    <a href="public/builder-construction/standalone.html" class="btn pink-and-orange-btn rounded-pill release_btn">VIEW ALL NEWS</a>
            ...
            <div class="col-lg-4">
                <div class="release-box wow slideInRight" data-wow-delay=".4s">
                    ...
                    <h4 class="box-text">
                        Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum standard dummy.s
                    </h4>
                    <a href="public/builder-construction/standalone.html" class="release-button">Learn More<i class="fas fa-angle-right"></i></a>
                    <hr>
                    <div class="release-img">
                        <img src="public/builder-construction/images/release-img-1.png" alt="release">
                        <h2 class="release-img-heading">
                            Pamela Smith
                        </h2>
                        <h1 class="img-date">
                            November 27, 2020
            ...
            <!-- release box -->
            <div class="col-lg-4">
                <div class="release-box wow slideInRight" data-wow-delay=".5s">
                    <h1 class="box-heading">
                        New Building Announced
                    </h1>
                    <h4 class="box-text">
                    ...
                    <hr>
                    <div class="release-img">
                        <img src="public/builder-construction/images/release-img-2.png" alt="release">
                        <h2 class="release-img-heading">
                            John Smith
                        </h2>
                        <h1 class="img-date-2">
